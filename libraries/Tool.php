...
class Tool
{
    ...
    public static function checkFilter($content)
    {
        ...
        //i:不区分大小写;u:非贪婪模式
        //①:任意单字符(排除\n以外的任意字符)连续出现五次
        //②[空白字符|0-9的数字|a-z的字母|。|?|!|，|、|；|：|“|”|‘|’|（|）|《|》|〈|〉|【|】|『|』|「|」|﹃|﹄|〔|〕|…|—|～|﹏|￥|!|@|#|$|%|^|&|*|(\)|~|,|.|?|[\]|-|=|_|+|:|"|;|{\}|/|<|>|\\|']连续出现五次以上(不要求相同的字符,只要是上述的字符连续出现五次即可)
        if (preg_match('/(.)\1{4,}|[\s|0-9|a-z|\x{4E00}\x{4E8C}\x{4E09}\x{56DB}\x{4E94}\x{516D}\x{4E03}\x{516B}\x{4E5D}\x{5341}\x{58F9}\x{8D30}\x{53C1}\x{8086}\x{4f0d}\x{9646}\x{67d2}\x{634c}\x{7396}\x{62fe}\x{3002}\x{ff1f}\x{ff01}\x{ff0c}\x{3001}\x{ff1b}\x{ff1a}\x{201c}\x{201d}\x{2018}\x{2019}\x{ff08}\x{ff09}\x{300a}\x{300b}\x{3008}\x{3009}\x{3010}\x{3011}\x{300e}\x{300f}\x{300c}\x{300d}\x{fe43}\x{fe44}\x{3014}\x{3015}\x{2026}\x{2014}\x{ff5e}\x{fe4f}\x{ffe5}\!\@\#\$\%\^\&\*\(\)\~\,\.\?\[\]\-\=\_\+\:\"\;\{\}\/\<\>\\\\\']{5,}/iu',
            $content)) {
            return false;
        }
        //'一二三四五六七八九十壹贰叁肆伍陆柒捌玖拾'}连续出现五次及以上
        if (preg_match('/[\x{4E00}\x{4E8C}\x{4E09}\x{56DB}\x{4E94}\x{516D}\x{4E03}\x{516B}\x{4E5D}\x{5341}\x{58F9}\x{8D30}\x{53C1}\x{8086}\x{4f0d}\x{9646}\x{67d2}\x{634c}\x{7396}\x{62fe}]{5,}/iu',
            $content)) {
            return false;
        }
        return true;
